function setupRightVideoSearch() {
	var srcs = [
	  ...
	  'https://cdn.jsdelivr.net/gh/duncangarde/right_video_remote@0.2/right_video_search.js',
	];
	if (window.jQuery) {} 
	else {
	...
	[
	  'https://cdn.jsdelivr.net/gh/duncangarde/right_video_remote@0.2/right_video_search.css'
